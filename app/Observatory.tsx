    ...
    <>
      ...
      <section className="terms" id="terms">
        ...
        <div className="term-map-shell">
          <div className="word-map" role="group" aria-label="Map of recurring AI job terms">{visibleTerms.map(item=>{
