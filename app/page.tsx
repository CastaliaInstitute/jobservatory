...
export default function Home() {
  return <main>
    <header className="masthead">
      <a className="wordmark" href="#top">JOBSERVATORY<span>/CASTALIA</span></a>
    ...
    <Observatory />
    <footer><a className="wordmark" href="#top">JOBSERVATORY<span>/CASTALIA</span></a><p>AI labor intelligence for public understanding.</p><span>VERSION 0.1 · EVIDENCE LEDGER</span></footer>
  </main>;
}
