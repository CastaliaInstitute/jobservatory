...
| Occupation and skill mapping | O*NET-SOC code/version, inferred flag, review state, listing-evidence crosswalk, inherited-profile semantics | Conservative title rules mapped 915/2,173; 1,330 skill mentions on 634 listings map to exact occupation-linked O*NET 30.3 software examples; mappings remain unreviewed |
