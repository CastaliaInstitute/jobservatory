...
The defensible CV bullet today is limited: Jobservatory has a provenance-aware 2,100+ record public corpus from 26 Greenhouse/Lever/Ashby feeds across 18 declared sectors, durable version/analysis lineage, structured compensation provenance, source-concentration diagnostics, a browser hybrid retrieval baseline, and a reproducible pinned semantic-retrieval/cross-encoder experiment with explicit rejection gates. It is not yet defensible to claim production semantic retrieval, superior cross-encoder reranking, extreme multi-label classification, calibrated predictions, low-latency serving, market trends, or forecasting.
