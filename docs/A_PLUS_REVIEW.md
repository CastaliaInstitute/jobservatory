...
| Licensing/provenance | B | Metadata/evidence-only export, source links, response hashes, feed schema versions, official public-API access documentation, a content-addressed data card, and O*NET attribution are present. Public access is explicitly separated from redistribution/training permission; source-by-source legal decisions remain pending. |
