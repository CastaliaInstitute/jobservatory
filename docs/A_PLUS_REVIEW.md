...
| UX/accessibility | B+ | Natural-language hybrid search, explicit error state, skip link, Escape-close, focus trapping/restoration, scroll locking, described dialog semantics, pressed term state, safe external links, and visible mobile navigation improved the surface. Automated accessibility tests and a complete assistive-technology audit remain. |
