...
assert all(item["status"] == "ok" and item["httpStatus"] == 200 and item["rightsReviewStatus"] and item["ats"] in {"greenhouse", "lever", "ashby", "smartrecruiters"} and item["sourceKey"] for item in corpus["coverage"]["retrieval"])
